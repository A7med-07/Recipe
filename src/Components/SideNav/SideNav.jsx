        ...
        <aside id="default-sidebar" className="fixed top-0 left-0 z-50 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div className='h-full px-3 overflow-y-auto bg-[#F9FAFB]'>
                ...
                <ul className='space-y-4 mt-6 font-medium'>
                    <li className='px-4 bg-amber-500 hover:scale-105 hover:shadow-xl hover:shadow-orange-50 transition-all mb-6 rounded-xl text-lg shadow-lg shadow-orange-300 font-semibold text-white'>
                        <a className='flex items-center p-2 rounded-lg' data-discover='true' href="/">
